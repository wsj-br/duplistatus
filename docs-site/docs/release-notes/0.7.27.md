...
Release notes for duplistatus version 0.7.27.
...
!!! warning
    **External integrations using the API must be updated** to work with version 0.7.27. See the [API Breaking Changes](../migration/api-changes.md) guide for details.
...
- **Better Performance**: Optimized database queries and indexing
...
- **Better Charts**: Improved chart visualization and interactivity
...
### Automatic Migration
The migration from 0.6.x to 0.7.27 happens automatically:
...
### Available Images
- **Docker Hub**: `wsjbr/duplistatus:0.7.27`
- **GitHub Container Registry**: `ghcr.io/wsj-br/duplistatus:0.7.27`
...
services:
  duplistatus:
    image: wsjbr/duplistatus:0.7.27
...
2. **Update Docker image**: `docker pull wsjbr/duplistatus:0.7.27`
...
2. **Then upgrade to 0.7.27** using the steps above
...
- **Migration Guide**: [Version 0.7 Migration](../migration/version-0.7.md)
