...
### Changed
- **Next.js telemetry**: `NEXT_TELEMETRY_DISABLED=1` is now set on `pnpm build`, `pnpm build-local`, `pnpm start`, and `pnpm dev` (Docker and `pnpm start-local` already set it), matching the documented default.
