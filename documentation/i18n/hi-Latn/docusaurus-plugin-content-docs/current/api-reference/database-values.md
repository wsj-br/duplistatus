...
Yah document mein Duplicati dwara bheje gaye JSON payload ka ek sample hai jab `--send-http-url` option ka istemal kiya jata hai. Yah us structure aur fields ko darshata hai jo duplistatus prapt karta hai aur persist karta hai. Kuch fields is udaharan mein clear ya redacted kiye ja sakte hain.
