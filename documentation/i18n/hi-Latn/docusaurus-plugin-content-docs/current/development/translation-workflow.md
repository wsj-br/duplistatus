...
- **Model / gunavatta** — `openrouter.translationModels` aur sambandhit vikalpon ko `ai-i18n-tools.config.json` mein adjust karen.
- **Shabdavali** — `documentation/glossary-user.csv` ko edit karen ya UI strings ko pun: utpann karen aur extract + translate ko pun: chalayen.
