---
translation_last_updated: '2026-01-31T00:51:23.392Z'
...
| `CRON_PORT`               | Port für den Cron-Service. Falls nicht gesetzt, verwendet `PORT + 1` | `9667`          |
...
| `PWD_ENFORCE`             | Auf `false` setzen, um Anforderungen an die Passwort-Komplexität zu deaktivieren (Großbuchstaben, Kleinbuchstaben, Zahlen). Die Mindestlänge wird immer erzwungen. | Erzwungen (vollständige Validierung) |
