---
translation_last_updated: '2026-05-06T23:22:00.018Z'
...
- **Behoben**: Warnungen bei pnpm install — peer webpack (allowedVersions) und veraltete Untergeordnete Abhängigkeiten (prebuild-install, whatwg-encoding) über allowedDeprecatedVersions in root package.json.
- **Behoben**: Anwendung-Protokollbetrachter useEffect exhaustive-deps Warnung (beabsichtigtes Abhängigkeits-Array; hinzugefügtes eslint-disable mit Kommentar).
...
- **Sicherheit**: pnpm overrides für minimatch (>=3.1.4) und serialize-javascript (>=7.0.3) zur Behebung von Schwachstellen mit hoher Schwere.
