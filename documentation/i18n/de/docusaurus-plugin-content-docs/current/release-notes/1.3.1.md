---
translation_last_updated: '2026-02-15T20:57:37.295Z'
...
- **Gemeinsame Übersetzungszeichenfolgen**: Komponenten verwenden jetzt konsistent gemeinsame Übersetzungen für Zeiteinheiten, Intervalle, Statusbezeichnungen und andere häufig verwendete Zeichenfolgen.
- **Locale-bewusste Wochentags-Sortierung**: Die Wochentags-Anzeige in der Sicherungsüberwachung berücksichtigt Ihr Locale (Montag–Sonntag für UK/Europa, Sonntag–Samstag für USA/Brasilien).
...
- **Hinzugefügt**: Mehrsprachige Oberflächenunterstützung mit Sprachauswahl in der App-Kopfzeile (en, de, fr, es, pt-BR)
- **Hinzugefügt**: Internationalisierung von Benachrichtigungsvorlagen mit Sprachauswahl und vorübersetzten Standardwerten
- **Hinzugefügt**: Locale-bewusste Datums-, Zeit- und Zahlenformatierung in der gesamten Anwendung
- **Hinzugefügt**: RTL-Unterstützungsvorbereitung für zukünftige Sprachen von rechts nach links
- **Geändert**: API-Authentifizierung jetzt erforderlich bei Sicherungen sammeln, Zeitplan synchronisieren, Cron-Konfiguration und Benachrichtigungsendpunkten
- **Geändert**: Dokumentationsseite von configure-tz-lang in configure-tz umbenannt
- **Geändert**: Benutzerhandbuch für Benachrichtigungsvorlagen und Mehrsprachunterstützung aktualisiert
- **Behoben**: Erkennungsfehler bei Hauptschlüsselwechsel bei Wiederherstellung der Datenbank mit gleichem Schlüssel
- **Behoben**: Relative Zeitformatierung in nicht-englischen Locales (Sicherungsüberwachungsformular)
- **Behoben**: Backup-Benachrichtigungsformular jetzt vollständig in allen 5 Locales übersetzt
- **Behoben**: Detailseite zeigt beim ersten Laden jetzt korrekt überfällige Meldung und Daten an
- **Behoben**: Lokalisierte Dokumentations-Screenshots für übersetzte Dokumentation
- **Verbessert**: Internationalisierungskonsistenz mit gemeinsamen Übersetzungszeichenfolgen
- **Verbessert**: Verbesserungen der Benutzeroberfläche (Server-Filter-Breite, Mehrfachauswahl-Pluralisierung, Hilfe-Tooltips)
