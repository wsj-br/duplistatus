...
### Wenn Sie Version 1.2.1 oder höher verwenden {/* #if-youre-running-version-121-or-later */}
...
### Wenn Sie eine Version vor 1.2.1 verwenden {/* #if-youre-running-a-version-before-121 */}
...
Wenn Sie Linux verwenden, brauchen Sie sich keine Sorgen um das Hochfahren von Hilfcontainern zu machen. Sie können den nativen `cp` Befehl verwenden, um die Datenbank direkt aus dem laufenden Container auf Ihren Host zu extrahieren.
...
Wenn Sie Docker Desktop unter Windows verwenden, haben Sie zwei einfache Möglichkeiten, dies ohne die Befehlszeile zu erledigen:

###### Option A: Verwenden Sie Docker Desktop (am einfachsten) {/* #option-a-use-docker-desktop-easiest */}
...
Wenn Sie Ihren Container ursprünglich mit einem Bind-Mount eingerichtet haben (z. B. haben Sie einen lokalen Ordner wie `/opt/duplistatus` mit dem Container verknüpft), benötigen Sie überhaupt keine Docker-Befehle. Kopieren Sie einfach die Datei mit Ihrem Dateimanager:
...
#### Wiederherstellung Ihrer Daten {/* #restoring-your-data */}
Wenn Sie Ihre Datenbank aus einer vorherigen Sicherung wiederherstellen müssen, folgen Sie den untenstehenden Schritten basierend auf Ihrem Betriebssystem.
...
Der einfachste Weg zur Wiederherstellung besteht darin, die Sicherungsdatei wieder in den internen Speicherpfad des Containers zu "pushen".
...
#### Sicherheitsnotizen {/* #security-notes */}
...
### Probleme mit dem Master-Key (0.8.x+) {/* #master-key-issues-08x */}
...
### Fehlersuche bei Ihrer Wiederherstellung / Rollback {/* #troubleshooting-your-restore--rollback */}
...
#### 4. Datenbankversionsinkompatibilität {/* #4-database-version-mismatch */}
...
## Datenbankschemasversionen {/* #database-schema-versions */}
