---
translation_last_updated: '2026-03-01T00:45:12.071Z'
...
1.  Navigieren Sie zu [Einstellungen → Datenbankwartung](database-maintenance.md).
2.  Klicken Sie im Abschnitt **Datenbankwiederherstellung** auf die Dateieingabe und wählen Sie eine Sicherungsdatei aus:
