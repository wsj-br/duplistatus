...
| **Gebietsschema-Format**         | Wählen Sie ein Formatierungsgebietsschema unabhängig von Ihrer UI-Sprache (416 Gebietsschemas werden unterstützt). Dies wirkt sich darauf aus, wie Daten, Zeiten und Zahlen angezeigt werden. Relative Zeitangaben (z. B. "in 2 Stunden") folgen dem Gebietsschema-Format, es sei denn, **Behalte die relative Zeit in der UI-Sprache** ist aktiviert. Eine Live-Vorschau enthält ein Datum, eine Uhrzeit, eine Zahl und ein Beispiel für eine relative Zeitangabe. Beispiel: UI-Sprache = Deutsch, Gebietsschema-Format = Englisch (UK) → Deutsch UI mit UK-Datumsformaten. | Basierend auf der UI-Sprache |
| **Behalte die relative Zeit in der UI-Sprache** | Wenn aktiviert, folgen Phrasen wie "in 2 Stunden" **Benutzer → Sprache** anstelle des Gebietsschema-Formats. Daten, Zeiten und Zahlen verwenden weiterhin das Gebietsschema-Format. Standardmäßig deaktiviert. | Aus |
