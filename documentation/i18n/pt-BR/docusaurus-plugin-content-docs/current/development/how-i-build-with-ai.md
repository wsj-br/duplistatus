...
1. Para a interface: [Firebase Studio do Google](https://firebase.studio/)
...
Criei um novo projeto no [Firebase Studio](https://studio.firebase.google.com/) e usei este prompt no recurso "Prototipar um aplicativo com IA":
...
Copiei uma amostra do JSON enviado pelo Duplicati para um arquivo (veja o documento [relatório de backup de amostra](../api-reference/database-values)), removendo alguns campos indesejados.
...
- Tenho a tendência de antropomorfizar o agente de IA dado que ele persistentemente usa 'nós', 'nosso código' e 'gostaria que eu...'. Isso também é para melhorar minhas chances de sobrevivência no caso (ou [quando](https://ai-2027.com/)) Skynet se tornar senciente e o Exterminador for inventado.
