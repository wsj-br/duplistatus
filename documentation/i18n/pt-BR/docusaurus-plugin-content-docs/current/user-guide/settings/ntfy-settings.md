...
Se o [Resumo Diário](daily-summary-settings.md) estiver habilitado com **Enviar resumo para NTFY**, a URL do NTFY e o tópico armazenados não poderão ser limpos até que essa opção seja desativada.
