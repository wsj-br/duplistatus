...
- **Método**: GET
- **Descrição**: Recupera dados agregados do gráfico com filtragem opcional de intervalo de tempo.
...
- **Método**: GET
- **Descrição**: Recupera dados do gráfico para um servidor específico com filtragem opcional de intervalo de tempo.
- **Parâmetros**:
...
- **Método**: GET
- **Descrição**: Recupera dados do gráfico para um servidor e backup específicos com filtragem opcional de intervalo de tempo.
- **Parâmetros**:
  - `serverId`: o identificador do servidor
  - `backupName`: o nome do backup (codificado para URL)
- **Parâmetros de Consulta**:
  - `startDate` (opcional): Data de início para filtragem (formato ISO)
  - `endDate` (opcional): Data de término para filtragem (formato ISO)
- **Resposta**:
...
- **Notas**:
  - Suporta filtragem de intervalo de tempo com os parâmetros startDate e endDate
  - Valida o formato da data antes do processamento
  - Retorna dados do gráfico para a combinação específica de servidor e backup
  - O nome do backup deve ser codificado para URL
