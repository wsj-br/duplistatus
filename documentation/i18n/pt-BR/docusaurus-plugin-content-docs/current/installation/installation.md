...
Consulte as seções a seguir para configurar as configurações opcionais, como fuso horário, formato de número e [configuração de segurança](security-configuration.md).
