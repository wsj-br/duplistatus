...
| `PWD_ENFORCE`             | Defina como `false` para desabilitar requisitos de complexidade de senha (maiúsculas, minúsculas, números). O comprimento mínimo é sempre aplicado. | Aplicado (validação completa) |
