...
Fácil de implantar com Docker, Podman ou Portainer e disponível em 5 idiomas (Português, Alemão, Francês, Espanhol e Português), com documentação completa em cada idioma.
