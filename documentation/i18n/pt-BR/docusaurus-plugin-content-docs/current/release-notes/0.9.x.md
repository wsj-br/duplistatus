---
translation_last_updated: '2026-02-05T00:21:11.793Z'
...
- **Log de Auditoria abrangente** para todas as alterações do sistema e ações do usuário
- **Visualizador de log de auditoria** com filtros avançados:
...
- **Estatísticas e análises do log de auditoria**
...
- **Log de auditoria para**:
  - Eventos de autenticação (login, sair, alterações de senha, bloqueios de conta)
...
- **Seções de configurações agrupadas**:
  ...
  - **Sistema**: servidores, Usuários (somente admin), Log de Auditoria
