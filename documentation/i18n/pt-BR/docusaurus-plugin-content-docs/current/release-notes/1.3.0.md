...
### Guia do Usuário Contextual {/* #context-aware-user-guide */}
...
### Exibição de Dia da Semana Sensível à Localização {/* #locale-aware-weekday-display */}
...
### Tratamento de Erros SMTP Aprimorado {/* #enhanced-smtp-error-handling */}
...
### Endpoint da Política de Senha {/* #password-policy-endpoint */}
...
### Mudanças na Versão 1.3.0 {/* #version-130-changes */}
