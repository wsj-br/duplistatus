---
translation_last_updated: '2026-02-15T20:57:45.923Z'
...
- **Strings de tradução comuns**: Os componentes agora usam consistentemente traduções compartilhadas para unidades de tempo, intervalos, rótulos de status e outras strings comuns.
- **Ordenação de dias da semana com reconhecimento de localidade**: A exibição de dias da semana no monitoramento de backup respeita sua localidade (segunda–domingo para Reino Unido/Europa, domingo–sábado para EUA/Brasil).
...
- **Adicionado**: Formatação de data, hora e número com reconhecimento de localidade em todo o aplicativo
...
- **Corrigido**: Formulário de notificações de backup agora totalmente traduzido em todas as 5 localidades
- **Corrigido**: Carregamento inicial da página de detalhes agora mostra mensagem de atraso e dados corretamente
- **Corrigido**: Screenshots de documentação localizados para documentos traduzidos
- **Melhorado**: Consistência de internacionalização com strings de tradução compartilhadas
- **Melhorado**: Melhorias na interface do usuário (largura do filtro de servidor, pluralização de seleção em massa, dicas de ajuda)
