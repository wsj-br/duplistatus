...
[Nginx](https://nginx.org/) est un serveur web populaire qui peut agir comme proxy inverse, et [Certbot](https://certbot.eff.org/) fournit des certificats SSL gratuits de Let's Encrypt.
...
Créer un `Caddyfile` avec le contenu suivant :
...
- [Guide du proxy inverse Caddy](https://caddyserver.com/docs/caddyfile/directives/reverse_proxy)
