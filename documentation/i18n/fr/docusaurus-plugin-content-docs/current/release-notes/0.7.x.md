---
translation_last_updated: '2026-02-05T00:20:51.128Z'
...
:::warning
**Les intégrations externes utilisant l'API doivent être mises à jour** pour fonctionner avec la version 0.7.x. Consultez le guide [API Breaking Changes](../migration/api-changes) pour plus de détails.
:::
