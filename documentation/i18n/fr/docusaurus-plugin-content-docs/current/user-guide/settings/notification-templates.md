---
translation_last_updated: '2026-01-31T00:51:23.082Z'
...
Tous les modèles prennent en charge des variables qui seront remplacées par des valeurs réelles. Le tableau suivant montre les variables disponibles :
...
| `{server_url}`         | URL du serveur Duplicati pour la configuration web   | Tous les modèles    |
