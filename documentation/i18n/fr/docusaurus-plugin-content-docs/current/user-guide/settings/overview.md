      ...
      <ul>
        <li>
          ...
          <ul>
            ...
            <li><a href="backup-monitoring-settings.md">Surveillance des sauvegardes</a> : Configurer la détection et les alertes des sauvegardes en retard</li>
            <li><a href="daily-summary-settings.md">Résumé quotidien</a> : Instantané quotidien facultatif qui remplace les e-mails envoyés au destinataire par défaut (les destinations supplémentaires continuent)</li>
        ...
        <li>
          ...
          <ul>
            ...
            <li><a href="duplicati-versions.md">Versions de Duplicati</a> : Afficher les versions de publication Duplicati mises en cache et configurer la planification de vérification des versions</li>
            <li><a href="database-maintenance.md">Maintenance de la base de données</a> : Effectuer le nettoyage de la base de données (administrateurs uniquement)</li>
            <li><a href="api-keys-settings.md">Clés API</a> : Gérer les clés avec portée et la protection API externe (administrateurs uniquement)</li>
            <li><a href="ip-allowlist-settings.md">Liste d'adresses IP autorisées</a> : Restreindre l'interface d'administration et les API externes (administrateurs uniquement)</li>
            <li><a href="user-management-settings.md">Utilisateurs</a> : Gérer les comptes utilisateur (administrateurs uniquement)</li>
            <li><a href="audit-logs-viewer.md">Journal d'audit</a> : Afficher les journaux d'audit système</li>
            <li><a href="audit-logs-retention.md">Conservation des journaux d'audit</a> : Configurer la conservation des journaux d'audit (administrateurs uniquement)</li>
            <li><a href="application-logs-settings.md">Journaux de l'application</a> : Afficher et exporter les journaux de l'application (administrateurs uniquement)</li>
          </ul>
        </li>
      </ul>
    </td>
...
<table>
  <tr>
    <td>
      ![Barre latérale des paramètres - Vue non-administrateur](../../assets/screen-settings-left-panel-non-admin.png)
    </td>
    <td>
      <ul>
        <li>
          ...
          <ul>
            ...
            <li><a href="daily-summary-settings.md">Résumé quotidien</a> : Afficher les paramètres du résumé quotidien (lecture seule)</li>
        ...
        <li>
          <strong id="system">Système</strong>
          <ul>
            <li><a href="server-settings.md">Serveurs</a> : Afficher les configurations serveur (lecture seule)</li>
            ...
            <li><a href="duplicati-versions.md">Versions de Duplicati</a> : Afficher les versions de publication de Duplicati mises en cache (les modifications de planning sont réservées à l'administrateur)</li>
...
Lorsque la configuration est invalide, les cases à cocher correspondantes dans l'onglet [Notifications de sauvegarde](backup-notifications-settings.md) seront grisé et désactivées. Pour plus de détails, consultez les pages [Paramètres NTFY](ntfy-settings.md) et [Paramètres de messagerie](email-settings.md).
