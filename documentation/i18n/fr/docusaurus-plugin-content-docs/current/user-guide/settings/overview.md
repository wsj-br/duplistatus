      ...
      <ul>
        <li>
          ...
          <ul>
            ...
            <li><a href="daily-summary-settings.md">Résumé quotidien</a>: Capture quotidienne facultative qui remplace les e-mails pour le destinataire par défaut (les destinations supplémentaires continuent)</li>
        ...
        <li>
          ...
          <ul>
            ...
            <li><a href="api-keys-settings.md">Clés API</a>: Gérer les clés étendues et la protection des API externes (admin uniquement)</li>
            <li><a href="ip-allowlist-settings.md">Liste d'adresses IP autorisées</a>: Restreindre l'interface d'administration et les API externes (admin uniquement)</li>
...
<table>
  <tr>
    <td>
      ![Paramètres de la barre latérale - Vue non-admin](../../assets/screen-settings-left-panel-non-admin.png)
    </td>
    <td>
      <ul>
        <li>
          <strong>Notifications</strong>
          <ul>
            <li><a href="backup-notifications-settings.md">Notifications de sauvegarde</a> : Voir les paramètres de notification par sauvegarde (lecture seule)</li>
            <li><a href="backup-monitoring-settings.md">Surveillance des sauvegardes</a> : Voir les paramètres de sauvegarde en retard (lecture seule)</li>
            <li><a href="daily-summary-settings.md">Résumé quotidien</a> : Voir les paramètres de résumé quotidien (lecture seule)</li>
            <li><a href="notification-templates.md">Modèles</a> : Voir les modèles de notification (lecture seule)</li>
          </ul>
        </li><br/>
        <li>
          <strong>Intégrations</strong>
          <ul>
            <li><a href="ntfy-settings.md">NTFY</a> : Voir les paramètres NTFY (lecture seule)</li>
            <li><a href="email-settings.md">E-mail</a> : Voir les paramètres de messagerie (lecture seule)</li>
          </ul>
        </li><br/>
        <li>
          <strong id="system">Système</strong>
          <ul>
            <li><a href="server-settings.md">Serveurs</a> : Voir les configurations des serveurs (lecture seule)</li>
            ...
            <li><a href="duplicati-versions.md">Versions de Duplicati</a> : Voir les versions de publication Duplicati mises en cache (les changements de programme sont réservés aux administrateurs)</li>
            <li><a href="audit-logs-viewer.md">Journal d'audit</a> : Voir les journaux d'audit système (lecture seule)</li>
          </ul>
        </li>
      </ul>
    </td>
...
- <IIcon2 icon="lucide:message-square" color="yellow"/> <IIcon2 icon="lucide:mail" color="yellow"/> **Icône jaune** : Vos paramètres ne sont pas valides ou non configurés

Lorsque la configuration est invalide, les cases à cocher correspondantes dans l'onglet [Notifications de sauvegarde](backup-notifications-settings.md) seront grises et désactivées. Pour plus de détails, consultez les pages [Paramètres NTFY](ntfy-settings.md) et [Paramètres de messagerie](email-settings.md).
