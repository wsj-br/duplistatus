...
# duplistatus - कई [Duplicati's](https://github.com/duplicati/duplicati) सर्वर की निगरानी करें {/* #duplistatus----monitor-multiple-duplicatishttpsgithubcomduplicatiduplicati-servers */}
...
यह वेब एप्लिकेशन [Duplicati](https://github.com/duplicati/duplicati) के बैकअप ऑपरेशन की निगरानी और दृश्यकरण करता है। **duplistatus** बैकअप स्थितियों को ट्रैक करने, बकाया बैकअप की सूचना देने, नौकरी के इतिहास, मेट्रिक्स और कई सर्वरों पर प्रदर्शन के लिए एक व्यापक डैशबोर्ड प्रदान करता है।

डॉकर, पॉडमैन या पोर्टेनर के साथ त्वरित रूप से तैनात करना आसान है और 7 भाषाओं (अंग्रेजी, जर्मन, फ्रेंच, स्पेनिश, पुर्तगाली, हिंदी और सरलीकृत चीनी) में उपलब्ध है, प्रत्येक भाषा में पूर्ण दस्तावेज़ीकरण के साथ।
...
[स्थापना गाइड](https://wsj-br.github.io/duplistatus/installation) |
