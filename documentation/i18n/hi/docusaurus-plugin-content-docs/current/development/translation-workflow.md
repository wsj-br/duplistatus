...
## जब अंग्रेज़ी डॉक्यूमेंटेशन बदलता है {/* #when-english-documentation-changes */}
...
## हेडिंग IDs और anchors {/* #heading-ids-and-anchors */}

लिंक स्थिर रहने के लिए स्पष्ट आईडी का उपयोग करें। MDX टिप्पणी सिंटैक्स का प्राथमिक उपयोग करें (`pnpm write-heading-ids` `--syntax mdx-comment` का उपयोग करता है):

```markdown
## This is a heading {/* #this-is-a-heading */}
```

आईडी `h2` और नीचे रखें। Docusaurus `write-heading-ids` `h1` को छोड़ देता है (पृष्ठ/साइडबार शीर्षक)। `documentation/docusaurus.config.ts` भी अनुमानित शीर्षकों से हेडिंग-आईडी टिप्पणियाँ हटा देता है, क्योंकि Docusaurus मेटाडेटा निष्कर्षण अभी भी केवल क्लासिक `{#id}` को हटा देता है।
...
## Docusaurus वस्तु शैली JSON {/* #docusaurus-theme-json */}
