...
## डॉकर हब {/* #update-readme-for-docker-hub */} के लिए रीडमी अपडेट करें
...
## गिटहब रिलीज नोट्स {/* #generate-github-release-notes */} उत्पन्न करें
...
## दस्तावेजीकरण {/* #take-screenshots-for-documentation */} के लिए स्क्रीनशॉट लें
...
## दस्तावेज़ीकरण {/* #deploying-the-documentation */} को डिप्लॉय करना
