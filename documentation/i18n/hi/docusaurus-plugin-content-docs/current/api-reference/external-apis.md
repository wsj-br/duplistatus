...
प्रमाणीकरण वैकल्पिक है और डिफ़ॉल्ट रूप से बंद है। यद्यपि कुंजियाँ वैकल्पिक हैं, क्लाइंट कुंजी को छोड़ सकते हैं या एक भेज सकते हैं: एक वैध मिलान-स्कोप कुंजी स्वीकार की जाती है और दर्ज की जाती है; एक खराब कुंजी पर ध्यान नहीं दिया जाता है और अनुरोध अभी भी आगे बढ़ता है। जब [एपीआई कुंजियाँ](../user-guide/settings/api-keys-settings.md) में **API कुंजियाँ आवश्यक हैं** सक्षम किया गया है, तो कुंजी को `?api_key=`, `X-Api-Key`, या `Authorization: Bearer` के रूप में भेजें। अपलोड करें कुंजियाँ केवल `POST /api/upload` पर काम करती हैं। पढ़ें कुंजियाँ केवल `/api/summary` और `/api/lastbackup*` पर काम करती हैं। क्वेरी-स्ट्रिंग कुंजियाँ रिवर्स-प्रॉक्सी एक्सेस लॉग में दिखाई देती हैं।

एक [आईपी अनुमति सूची](../user-guide/settings/ip-allowlist-settings.md) भी इन रूटों को प्रतिबंधित कर सकती है। `/api/health` और `/api/ping` दोनों सूचियाँ बंद होने पर सार्वजनिक रहती हैं; जब कोई भी सूची सक्रिय होती है तो वे प्रशासन या बाहरी सूची से लूपबैक और सीआईडीआर स्वीकार करती हैं, और गैर-लूपबैक ग्राहकों को दर-सीमा लगाई जाती है।

## समग्र सारांश प्राप्त करें - `/api/summary` {/* #get-overall-summary---apisummary */}
- **Endpoint**: `/api/summary`
- **Method**: GET
- **विवरण**: सभी सर्वर पर सभी बैकअप संचालन का सारांश प्राप्त करता है।
- **Response**:
...
- **Method**: GET
- **विवरण**: किसी विशिष्ट सर्वर पर सभी कॉन्फ़िगर किए गए बैकअप (जैसे 'Files', 'Databases') के लिए नवीनतम बैकअप जानकारी प्राप्त करता है।
- **पैरामीटर**:
  - `serverId`: सर्वर पहचानकर्ता (आईडी या नाम)
...
- **Endpoint**: `/api/upload`
- **Method**: POST
- **विवरण**: किसी सर्वर के लिए बैकअप संचालन डेटा अपलोड करता है। डुप्लिकेट बैकअप रन पहचान का समर्थन करता है और सूचनाएं भेजता है।
