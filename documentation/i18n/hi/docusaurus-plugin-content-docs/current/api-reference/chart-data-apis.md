...
## संकलित चार्ट डेटा प्राप्त करें - `/api/chart-data/aggregated` {/* #get-aggregated-chart-data---apichart-dataaggregated */}
- **एंडपॉइंट**: `/api/chart-data/aggregated`
- **मेथड**: GET
- **विवरण**: वैकल्पिक समय सीमा फ़िल्टरिंग के साथ संकलित चार्ट डेटा प्राप्त करता है।
- **क्वेरी पैरामीटर**:
...
- **त्रुटि प्रतिक्रियाएं**:
  ...
  - `500`: चार्ट डेटा लाते समय सर्वर त्रुटि
- **नोट्स**:
  - startDate और endDate पैरामीटर्स के साथ समय सीमा फ़िल्टरिंग का समर्थन करता है
  - प्रोसेस करने से पहले तिथि प्रारूप को मान्य करता है
  - सभी सर्वर का संकलित डेटा लौटाता है
