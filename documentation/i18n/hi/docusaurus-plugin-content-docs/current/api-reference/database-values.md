...
यह दस्तावेज़ `--send-http-url` विकल्प का उपयोग करते हुए डुप्लिकेटी द्वारा भेजे गए JSON पेलोड का एक नमूना शामिल करता है। यह duplistatus द्वारा प्राप्त और संग्रहीत होने वाले संरचना और फ़ील्ड को दर्शाता है। कुछ फ़ील्ड इस उदाहरण में साफ़ या रेडक्टेड हो सकते हैं।
