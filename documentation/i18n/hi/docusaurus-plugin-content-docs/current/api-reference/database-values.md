...
इस दस्तावेज़ में `--send-http-json-urls` (या `--send-http-result-output-format=Json` के साथ लेगेसी `--send-http-url` विकल्प) का उपयोग करते समय Duplicati द्वारा भेजे गए JSON पेलोड का एक नमूना शामिल है। यह उस संरचना और फ़ील्ड्स को दर्शाता है जिन्हें duplistatus प्राप्त करता है और सहेजता है। इस उदाहरण में कुछ फ़ील्ड्स को रिक्त या संपादित किया गया हो सकता है।
