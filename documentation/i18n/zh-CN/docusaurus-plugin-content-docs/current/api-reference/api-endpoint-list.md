...
| [`/api/audit-log/filters`](administration-apis#get-audit-log-filter-values---apiaudit-logfilters)                                                   | GET    | 获取审计日志筛选值       | 管理            |
| [`/api/audit-log/retention`](administration-apis#get-audit-log-retention---apiaudit-logretention)                                                   | GET    | 获取审计日志保留策略           | 管理            |
| [`/api/audit-log/retention`](administration-apis#update-audit-log-retention---apiaudit-logretention)                                                | PATCH  | 更新审计日志保留策略        | 管理            |
...
| [`/api/database/restore`](administration-apis#restore-database---apidatabaserestore)                                                                | POST   | 还原数据库                  | 管理            |
| [`/api/auth/admin-must-change-password`](authentication-security#check-admin-must-change-password---apiauthadmin-must-change-password)              | GET    | 检查管理员是否必须更改密码  | 认证与安全 |
...
| [`/api/auth/logout`](authentication-security#logout---apiauthlogout)                                                                                | POST   | 登出                            | 认证与安全 |
...
| [`/api/dashboard`](core-operations#get-dashboard-data-consolidated---apidashboard)                                                                  | GET    | 获取仪表板数据（合并） | 核心操作           |
| [`/api/detail/:serverId`](core-operations#get-server-data-with-overdue-info---apidetailserverid)                                                    | GET    | 获取含逾期信息的服务器数据 | 核心操作           |
