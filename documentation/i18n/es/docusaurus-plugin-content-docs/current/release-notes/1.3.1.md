---
translation_last_updated: '2026-02-15T20:57:41.650Z'
...
- **Cadenas de traducción comunes**: Los componentes ahora utilizan consistentemente traducciones compartidas para unidades de tiempo, intervalos, etiquetas de estado y otras cadenas comunes.
- **Ordenamiento de días de la semana según la configuración regional**: La visualización de días de la semana en la supervisión de backups respeta tu configuración regional (lunes–domingo para Reino Unido/Europa, domingo–sábado para EE.UU./Brasil).
...
- **Cambiado**: Autenticación de API ahora requerida en los puntos finales de recopilación de backups, sincronización de programación, configuración de cron y notificaciones
...
- **Corregido**: Detección de falsos positivos en cambio de clave maestra al restaurar base de datos con la misma clave
- **Corregido**: Formato de tiempo relativo en configuraciones regionales que no son inglés (formulario de supervisión de backups)
- **Corregido**: Formulario de notificaciones de backup ahora completamente traducido en las 5 configuraciones regionales
- **Corregido**: Página de detalles ahora muestra correctamente el mensaje de retrasado y los datos en la carga inicial
...
- **Mejorado**: Mejoras de interfaz de usuario (ancho de filtro de servidor, pluralización de selección masiva, información sobre herramientas de ayuda)
