...
### Visualización de Días de la Semana Consciente de la Localidad {/* #locale-aware-weekday-display */}
...
### Endpoint de Política de Contraseña {/* #password-policy-endpoint */}

- `GET /api/auth/password-policy` - Devuelve la configuración actual de la política de contraseñas

### Endpoints de Registros de la Aplicación {/* #application-logs-endpoints */}
...
### Endpoints Eliminados {/* #removed-endpoints */}
