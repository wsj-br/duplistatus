---
translation_last_updated: '2026-02-05T00:21:04.550Z'
...
### Cambios Disruptivos de API {#api-breaking-changes}
...
:::warning
**Las integraciones externas que utilizan la API deben actualizarse** para funcionar con la versión 0.7.x. Consulte la guía [API Breaking Changes](../migration/api-changes) para obtener más detalles.
:::
