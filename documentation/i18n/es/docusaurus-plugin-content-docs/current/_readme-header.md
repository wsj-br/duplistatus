...
Fácil de implementar con Docker, Podman o Portainer y disponible en 7 idiomas (inglés, alemán, francés, español, portugués, hindi (romano) y chino simplificado), con documentación completa en cada idioma.
