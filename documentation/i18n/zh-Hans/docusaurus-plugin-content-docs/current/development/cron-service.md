...
- **Duplicati 版本刷新**：从 GitHub Releases 更新缓存的最新 Duplicati 频道版本。默认每天 UTC 时间 3 点运行；管理员可以在[设置 → Duplicati 版本](../user-guide/settings/duplicati-versions.md)中更改间隔和开始时间。
- **灵活调度**：为不同任务配置可灵活调整的 cron 表达式
