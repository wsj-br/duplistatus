...
| [`/api/audit-log/filters`](administration-apis#get-audit-log-filter-values---apiaudit-logfilters)                                                   | GET    | 获取审计日志过滤器值       | 管理            |
...
| [`/api/auth/logout`](authentication-security#logout---apiauthlogout)                                                                                | POST   | 登出                            | 身份验证与安全 |
...
| [`/api/summary`](external-apis#get-overall-summary---apisummary)                                                                                    | GET    | 获取总体摘要                      | 外部API                   |
