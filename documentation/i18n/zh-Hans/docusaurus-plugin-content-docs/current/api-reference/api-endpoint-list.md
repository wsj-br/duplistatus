...
| [`/api/database/restore`](administration-apis#restore-database---apidatabaserestore)                                                                | POST   | 还原数据库                  | 管理员                    |
| [`/api/auth/admin-must-change-password`](authentication-security#check-admin-must-change-password---apiauthadmin-must-change-password)              | GET    | 检查管理员必须更改密码  | 身份验证和安全性 |
| [`/api/auth/change-password`](authentication-security#change-password---apiauthchange-password)                                                     | POST   | 更改密码                   | 身份验证和安全性 |
| [`/api/auth/login`](authentication-security#login---apiauthlogin)                                                                                   | POST   | 登录                             | 身份验证和安全性 |
| [`/api/auth/logout`](authentication-security#logout---apiauthlogout)                                                                                | POST   | 登出                            | 身份验证和安全性 |
| [`/api/auth/me`](authentication-security#get-current-user---apiauthme)                                                                              | GET    | 获取当前用户                  | 身份验证和安全性 |
| [`/api/auth/password-policy`](authentication-security#get-password-policy---apiauthpassword-policy)                                                 | GET    | 获取密码策略               | 身份验证和安全性 |
| [`/api/backups/cleanup`](administration-apis#cleanup-backups---apibackupscleanup)                                                                   | POST   | 清理备份                   | 管理员                    |
| [`/api/backups/collect`](administration-apis#collect-backups---apibackupscollect)                                                                   | POST   | 收集备份                   | 管理员                    |
| [`/api/backups/delete-job`](administration-apis#delete-backup-job---apibackupsdelete-job)                                                           | DELETE | 删除备份作业                 | 管理                    |
...
| [`/api/csrf`](session-management-apis#get-csrf-token---apicsrf)                                                                                     | GET    | 获取 CSRF Token                    | 会话管理        |
...
| [`/api/servers/:id`](core-operations#get-server-details---apiserversid)                                                                             | GET    | 获取服务器详细信息                | 核心操作           |
