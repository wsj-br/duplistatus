...
设置页面提供了一个统一的界面，用于配置所有方面的 **duplistatus**。您可以通过点击 <IconButton icon="lucide:settings" /> **设置** 按钮访问它，位于 [应用程序工具栏](../overview.md#application-toolbar)。请注意，普通用户将看到一个简化的菜单，选项比管理员少。
...
<table>
  <tr>
    <td>
      ![设置侧边栏 - 管理视图](../../assets/screen-settings-left-panel-admin.png)
    </td>
    <td>
      <ul>
        <li>
          ...
          <ul>
            ...
            <li><a href="daily-summary-settings.md">每日摘要</a>: 可选的每日快照，替代发送给默认收件人的电子邮件（其他目标继续）</li>
        ...
        <li>
          ...
          <ul>
            ...
            <li><a href="duplicati-versions.md">Duplicati 版本</a>: 查看缓存的Duplicati发布版本并配置版本检查计划</li>
            <li><a href="database-maintenance.md">数据库维护</a>: 执行数据库清理（仅限管理员）</li>
            <li><a href="api-keys-settings.md">API 密钥</a>: 管理作用域密钥和外部API保护（仅限管理员）</li>
    ...
    <td>
      <ul>
        ...
        <li>
          <strong>集成</strong>
          <ul>
            <li><a href="ntfy-settings.md">NTFY</a>：查看NTFY设置（只读）</li>
        ...
        <li>
          ...
          <ul>
            ...
            <li><a href="duplicati-versions.md">Duplicati 版本</a>：查看缓存的Duplicati发布版本（计划更改仅限管理员）</li>
...
当配置无效时，[备份通知](backup-notifications-settings.md)选项卡中的相应复选框将变灰并被禁用。有关更多详细信息，请参见[NTFY设置](ntfy-settings.md)和[电子邮件设置](email-settings.md)页面。

<br/>

:::important
绿色图标并不一定意味着通知正常工作。在依赖通知之前，请始终使用可用的测试功能确认您的通知是否正常工作。
:::
