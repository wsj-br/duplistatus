...
![服务器详细信息 - 过期的计划备份](../assets/screen-server-overdue-message.png)
...
:::tip 提示
• 在**备份历史**部分中，使用下拉菜单选择**所有备份**或特定备份。

• 点击任何列的标题可对该列进行排序，再次点击可反转排序顺序。

• 点击任何行以查看[备份详细信息](#backup-details)。
...
![备份详细信息](../assets/screen-backup-detail.png)
