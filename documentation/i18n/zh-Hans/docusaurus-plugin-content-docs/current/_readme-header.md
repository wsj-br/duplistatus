...
# duplistatus - 监控多个 [Duplicati](https://github.com/duplicati/duplicati) 服务器
...
易于使用 Docker、Podman 或 Portainer 进行部署，提供 7 种语言（英语、德语、法语、西班牙语、葡萄牙语、印地语（罗马化）和简体中文），且每种语言均包含完整文档。
