...
- **API reference**: The [Authentication & Security](../api-reference/authentication-security.md#auth-api-error-and-success-codes-i18n) API docs list all error and success codes and explain how to use them for i18n.
