...
- **Fixed DNS resolution for Tailscale hostnames** - Resolved DNS resolution issues in Podman containers that prevented connecting to Tailscale hostnames or customs DNS servers. Updated the install documentation with instructions. 
