...
| **Version**                     | The Duplicati version from the latest backup log, with the same colour and tooltip as the [dashboard](../dashboard.md#duplicati-server-version). Muted text is current or unavailable; warning yellow is outdated. |
