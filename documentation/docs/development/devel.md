...
This starts both the Next.js app (port 8666) and the cron service (port 8667). CTRL-C stops both. Use `pnpm dev:next` or `pnpm cron:dev` to run either process alone.
