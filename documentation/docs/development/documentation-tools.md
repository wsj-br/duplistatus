...
- `pnpm write-heading-ids` - Write explicit `{#id}` heading anchors into markdown using Docusaurus rules (run from `documentation/` for stable links across translations)
