...
> 
> - Adjust the timezone and language settings to receive notifications in the correct time zone and number/date/time format. See details in the [Timezone and Locale](installation/configure-tz-lang.md) section.
>
