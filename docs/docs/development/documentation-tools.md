...
The documentation is built using [Docusaurus](https://docusaurus.io/) and is located in the `docs` folder.
...
This generates static HTML files in the `docs/build` directory.
...
This serves the built site from the `docs/build` directory.
...
The project's `README.md` file is automatically generated from `docs/docs/intro.md` to keep the GitHub repository README synchronised with the Docusaurus documentation.
...
- Copies content from `docs/docs/intro.md`
...
- Saves screenshots to `docs/static/img/`
...
The script generates the following screenshots (saved to `docs/static/img/`):
...
- Documentation files are written in Markdown (`.md`) and located in `docs/docs/`
- The sidebar navigation is configured in `docs/sidebars.ts`
- Docusaurus configuration is in `docs/docusaurus.config.ts`
- Custom React components can be added to `docs/src/components/`
- Static assets (images, PDFs, etc.) go in `docs/static/`
- The main documentation homepage is `docs/docs/intro.md`, which is used as the source for generating `README.md`
