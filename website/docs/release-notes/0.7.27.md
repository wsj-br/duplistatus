...
> [!WARNING]
> **External integrations using the API must be updated** to work with version 0.7.27. See the [API Breaking Changes](../migration/api-changes) guide for details.
...
- **Migration Guide**: [Version 0.7 Migration](../migration/version-0.7)
