...
export default {
  ...
  "content": {
    ...
    "translation": {
      "en": {
        ...
        "note": "Note:",
        "defaultLoginCredentialsAre": "Default login credentials are",
        "loading": "Loading...",
      ...
      "de": {
        ...
        "logIn": "Anmelden",
        "enterYourCredentials": "Geben Sie Ihre Anmeldedaten ein, um auf Ihr Konto zuzugreifen",
        "note": "Hinweis:",
        "defaultLoginCredentialsAre": "Standard-Anmeldedaten sind",
        "loading": "Laden...",
      ...
      "fr": {
        ...
        "note": "Note:",
        "defaultLoginCredentialsAre": "Les identifiants de connexion par défaut sont",
        "loading": "Chargement...",
      ...
      "es": {
        ...
        "enterYourCredentials": "Ingrese sus credenciales para acceder a su cuenta",
        "note": "Nota:",
        "defaultLoginCredentialsAre": "Las credenciales de inicio de sesión predeterminadas son",
        "loading": "Cargando...",
      ...
      "pt-BR": {
        ...
        "logIn": "Entrar",
        "enterYourCredentials": "Digite suas credenciais para acessar sua conta",
        "note": "Nota:",
        "defaultLoginCredentialsAre": "As credenciais de login padrão são",
        "loading": "Carregando...",
  ...
  "localIds": [
    "login-page::local::src/app/[locale]/login/page.content.ts"
  ]
} as const;
