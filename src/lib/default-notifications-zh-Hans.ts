...
import { defaultDailySummaryZhHans } from './default-daily-summary-templates';

/**
 * Simplified Chinese (zh-Hans) default notification templates
 */
export const defaultNotificationTemplatesZhHans: {
  overdueBackup: NotificationTemplate;
  success: NotificationTemplate;
  warning: NotificationTemplate;
  dailySummary: typeof defaultDailySummaryZhHans;
} = {
  success: {
  ...
  dailySummary: defaultDailySummaryZhHans,
};

/** @deprecated Use defaultNotificationTemplatesZhHans. Legacy stored locale code zh-CN maps via parseLocaleTag. */
export const defaultNotificationTemplatesZhCN = defaultNotificationTemplatesZhHans;
