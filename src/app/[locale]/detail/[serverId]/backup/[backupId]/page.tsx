...
const LogSection = ({
  ...
  return (
    <Card className={getLogSectionBorderClass(variant)}>
      <CardHeader>
        <CardTitle className={getLogSectionTitleClass(variant)}>{title}</CardTitle>
        <CardDescription>
          {isTruncated ? (
            ...
            <div className="text-sm font-normal text-muted-foreground">Showing all messages ({expectedLines})</div>
          )}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div
          ...
          style={{ maxHeight: "400px", overflowY: "auto", overflowX: "hidden", width: "100%" }}
        >
    ...
    <div className="w-[95%] mx-auto py-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold">
          ...
          <span className="text-muted-foreground font-normal" title={server.alias ? server.name : undefined}>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-xl" title={server.alias ? server.name : undefined}>
                  {server.alias || server.name}
                  {server.alias ? ` (${server.name})` : ""}
                  {server.note && (
                    <span className="text-muted-foreground font-normal text-lg ml-2"> - {server.note}</span>
                  )}
                </CardTitle>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <dd className="mx-4 flex items-center gap-6">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-muted-foreground">({formatRelativeTime(safeBackup.date, undefined, locale)})</span>
                    </div>
                    <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <dd className="text-sm">
                  <AvailableBackupsTable availableBackups={availableBackups} currentBackupDate={safeBackup.date} locale={locale} />
                </dd>
              </div>
            </div>
          </CardContent>
