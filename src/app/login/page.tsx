      ...
      if (!response.ok) {
        const message = (() => {
          switch (data.errorCode) {
            ...
            case 'ACCOUNT_LOCKED':
              return t("Account locked. Please try again later.");
            case 'DATABASE_NOT_READY':
              return t("Database is not ready. Please try again in a moment.");
            case 'INTERNAL_ERROR':
              return t("Internal server error");
            default:
              return data.error || t("Login failed");
          }
        })();
        setError(message);
        setLoading(false);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background relative">
            ...
            <Card className="border-blue-200 bg-blue-50/50 dark:bg-blue-950/20 dark:border-blue-800">
              <CardContent className="pt-6">
                <div className="text-sm text-blue-900 dark:text-blue-100">
                  ...
                  <p>
                    {t("Default login credentials are")}{" "}
      ...
      <div className="flex flex-col items-center gap-0.5">
        ...
        <span className="text-tiny text-muted-foreground text-center max-w-md px-4">
