...
export default {
  ...
  content: {
    ...
    description: t({ 
      ...
      es: 'Ver entradas del log de auditoría de la aplicación', 
      'pt-BR': 'Ver entradas do log de auditoria do aplicativo' 
    }),
    retention: t({ 
      en: 'Log Retention', 
    ...
    auditLogViewer: t({ 
      ...
      es: 'Visor de log de auditoría', 
      'pt-BR': 'Visualizador de log de auditoria' 
    }),
    ...
    refreshAuditLogs: t({ 
      ...
      es: 'Actualizar logs de auditoría', 
      'pt-BR': 'Atualizar logs de auditoria' 
    }),
    // Filters
    auditLogViewerFilters: t({ 
      ...
      es: 'Visor de log de auditoría - Filtros', 
      'pt-BR': 'Visualizador de log de auditoria - Filtros' 
    }),
    reset: t({ 
      en: 'Reset', 
      de: 'Zurücksetzen', 
    ...
    loadingAuditLogs: t({ 
      ...
      es: 'Cargando logs de auditoría...', 
      'pt-BR': 'Carregando logs de auditoria...' 
    }),
    noAuditLogsFound: t({ 
      en: 'No audit logs found', 
      de: 'Keine Audit-Logs gefunden', 
      fr: 'Aucun journal d\'audit trouvé', 
      es: 'No se encontraron logs de auditoría', 
      'pt-BR': 'Nenhum log de auditoria encontrado' 
    }),
    // Table headers
    tableNumber: t({ 
      en: '#', 
    ...
    noMoreLogsToLoad: t({ 
      ...
      es: 'No hay más logs para cargar', 
      'pt-BR': 'Não há mais logs para carregar' 
    }),
    // Pagination
    loadedXOfYTotal: t({ 
    ...
    auditLogDetails: t({ 
      ...
      es: 'Detalles del log de auditoría', 
      'pt-BR': 'Detalhes do log de auditoria' 
    }),
    completeInformationForAuditLogEntry: t({ 
      ...
      es: 'Información completa para la entrada del log de auditoría #{id}', 
      'pt-BR': 'Informações completas para a entrada do log de auditoria #{id}' 
    }),
    // Dialog field labels
    timestampLabel: t({ 
      en: 'Timestamp', 
    ...
    failedToLoadAuditLogs: t({ 
      ...
      es: 'Error al cargar logs de auditoría', 
      'pt-BR': 'Falha ao carregar logs de auditoria' 
    }),
    failedToLoadMoreAuditLogs: t({ 
      ...
      es: 'Error al cargar más logs de auditoría', 
      'pt-BR': 'Falha ao carregar mais logs de auditoria' 
    }),
    failedToLoadFilterValues: t({ 
      ...
      es: 'Error al cargar valores de filtro. Usando solo logs cargados.', 
      'pt-BR': 'Falha ao carregar valores de filtro. Usando apenas logs carregados.' 
    }),
    auditLogDownloadedAs: t({ 
      ...
      es: 'Log de auditoría descargado como {format}', 
      'pt-BR': 'Log de auditoria baixado como {format}' 
    }),
    failedToDownloadAuditLogs: t({ 
      ...
      es: 'Error al descargar logs de auditoría', 
      'pt-BR': 'Falha ao baixar logs de auditoria' 
    }),
  },
