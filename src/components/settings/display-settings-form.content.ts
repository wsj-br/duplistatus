...
export default {
  ...
  content: {
    ...
    startOfWeekLabel: t({
      en: 'Start of Week',
      de: 'Wochenbeginn',
      fr: 'Début de la semaine',
      es: 'Inicio de la semana',
      'pt-BR': 'Início da semana',
    }),
    startOfWeekPlaceholder: t({
      en: 'Select start of week',
      de: 'Wochenbeginn auswählen',
      fr: 'Sélectionner le début de la semaine',
      es: 'Seleccionar inicio de la semana',
      'pt-BR': 'Selecionar início da semana',
    }),
    basedOnLocale: t({
      en: 'Based on locale',
      de: 'Nach Locale',
      fr: 'Basé sur la locale',
      es: 'Basado en la configuración regional',
      'pt-BR': 'Baseado na localização',
    }),
    startOfWeekSunday: t({
      en: 'Sunday',
      de: 'Sonntag',
