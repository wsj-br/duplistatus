  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        style={{ 
          width: '100%', 
          height: isAspectAuto ? '100%' : undefined,
          minHeight: isAspectAuto ? '100px' : undefined,
          ...style 
        }}
        {...props}
      >
...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    label?: unknown
    labelFormatter?: (label: unknown, payload: Array<TooltipPayloadItem>) => React.ReactNode
    formatter?: (value: unknown, name: unknown, props: TooltipPayloadItem, index?: number, payload?: Record<string, unknown>) => React.ReactNode
    hideLabel?: boolean
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-fit items-start gap-1.5 rounded-lg border border-border/50 bg-background px-2 py-1 text-xs shadow-xl",
          className
        )}
      >
